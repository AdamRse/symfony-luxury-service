 ...
 */
final class Version20240322085844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidates (id INT AUTO_INCREMENT NOT NULL, job_candidates_id INT DEFAULT NULL, notes_candidates_id INT DEFAULT NULL, notes_jobs_id INT DEFAULT NULL, f_name VARCHAR(255) DEFAULT NULL, l_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, available TINYINT(1) DEFAULT NULL, dt_inscription DATETIME DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, has_passport TINYINT(1) DEFAULT NULL, birthdate DATE DEFAULT NULL, description VARCHAR(4095) DEFAULT NULL, gender TINYINT(1) DEFAULT NULL, dt_updated DATETIME DEFAULT NULL, dt_deleted DATETIME DEFAULT NULL, INDEX IDX_6A77F80CD681EDD8 (job_candidates_id), INDEX IDX_6A77F80C747CAAF8 (notes_candidates_id), INDEX IDX_6A77F80C48A60A73 (notes_jobs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE job_candidates (id INT AUTO_INCREMENT NOT NULL, aproved TINYINT(1) NOT NULL, dt_creation DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jobs (id INT AUTO_INCREMENT NOT NULL, job_candidates_id INT DEFAULT NULL, notes_jobs_id INT DEFAULT NULL, reference VARCHAR(255) NOT NULL, description VARCHAR(4095) NOT NULL, active TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, salary INT NOT NULL, dt_closing DATE NOT NULL, dt_creation DATETIME NOT NULL, INDEX IDX_A8936DC5D681EDD8 (job_candidates_id), INDEX IDX_A8936DC548A60A73 (notes_jobs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_jobs (id INT AUTO_INCREMENT NOT NULL, jobs_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, INDEX IDX_7F9CA8CD48704627 (jobs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, candidate_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64991BD8781 (candidate_id), UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE candidates ADD CONSTRAINT FK_6A77F80CD681EDD8 FOREIGN KEY (job_candidates_id) REFERENCES job_candidates (id)');
        ...
        $this->addSql('ALTER TABLE type_jobs ADD CONSTRAINT FK_7F9CA8CD48704627 FOREIGN KEY (jobs_id) REFERENCES jobs (id)');
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D64991BD8781 FOREIGN KEY (candidate_id) REFERENCES candidates (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidates DROP FOREIGN KEY FK_6A77F80CD681EDD8');
        ...
        $this->addSql('ALTER TABLE type_jobs DROP FOREIGN KEY FK_7F9CA8CD48704627');
